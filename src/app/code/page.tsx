            ...
            <div>
                ...
                <section className="mt-5">
                    ...
                    <div>
                        ...
                        <p className="text-base">right now
                        ...
                        <p className="text-base">you&apos;ll probably keep using it when you&apos;re working at your first job. or your second.</p>

                        <p className="text-base">or when you&apos;re building your own thing</p>
                        ...
                        <p className="text-base">you&apos;re right in the middle of a billion-dollar race
                        </p>

                        <p className="text-base">and your attention, your habits, your trust is what everyone&apos;s chasing
                        </p>
                    </div>
                </section>
