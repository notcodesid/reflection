    ...
    return (
        ...
        <div className="reflection-container pt-8">
            ...
            <section className="hidden md:block pt-[3rem] pb-[2rem]">
                <h1 className="md:text-7xl font-medium font-serif ">how to get hire</h1>
            </section>

            <section className="mb-16 md:hidden">
                <h1 className="text-4xl font-normal font-serif mb-6">how to get hire</h1>
            </section>
            ...
            <section className=" mb-16 border-gray-300 pt-8">
                <h2 className="text-sm font-sans tracking-wide mb-6">take your time to find the right job</h2>
            ...
            <section className="mb-16 border-t border-gray-300 pt-8">
                <h2 className="text-sm font-sans tracking-wide mb-6">get involved early</h2>
            ...
            <section className="mb-16 border-t border-gray-300 pt-8">
                <h2 className="text-sm font-sans tracking-wide mb-6">be smart, but also get stuff done</h2>
            ...
            <section className="mb-16 border-t border-gray-300 pt-8">
                <h2 className="text-sm font-sans tracking-wide mb-6">prepare for the job, not just the interview</h2>
            ...
            <section className="mb-16 border-t border-gray-300 pt-8">
                <h2 className="text-sm font-sans tracking-wide mb-6">do a trial project</h2>
