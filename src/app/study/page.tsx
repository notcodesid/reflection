        ...
        <div className="reflection-container pt-8">
            <div className="my-[4rem]">
                <section className="hidden md:block pt-[3rem] pb-[2rem]">
                    <h1 className="md:text-7xl font-medium">how to Study 4 hours every day </h1>
                </section>

                <section className="md:hidden">
                    <h1 className="text-4xl font-normal mb-6">effective studying</h1>
                </section>
            ...
            <section className="mb-16 border-t border-gray-300 pt-8">
                ...
                <ul className="list-disc pl-8 my-4 text-lg md:text-xl space-y-2">
                    <li>math</li>
            ...
            <section className="mb-16 border-t border-gray-300 pt-8">
                <h2 className="text-sm tracking-wide mb-6">fewer hobbies</h2>
            ...
            <section className="mb-16 border-t border-gray-300 pt-8">
                <h2 className="text-sm tracking-wide mb-6">buy time, not just coffee</h2>
            ...
            <section className="mb-16 border-t border-gray-300 pt-8">
                <h2 className="text-sm tracking-wide mb-6">multitasking intelligence</h2>
            ...
            <section className="mb-16 border-t border-gray-300 pt-8">
                <h2 className="text-sm tracking-wide mb-6">energy {'>'} hours</h2>
            ...
            <section className="mb-16 border-t border-gray-300 pt-8">
                <h2 className="text-sm tracking-wide mb-6">change environment</h2>
            ...
            <section className="mb-16 border-t border-gray-300 pt-8">
                <h2 className="text-sm tracking-wide mb-6">sleep as your brain depends on it (it does)</h2>
            ...
            <section className="mb-16 border-t border-gray-300 pt-8">
                <h2 className="text-sm tracking-wide mb-6">focus on one thing</h2>
            ...
            <section className="mb-16 border-t border-gray-300 pt-8">
                <h2 className="text-sm tracking-wide mb-6">default actively</h2>
            ...
            <section className="border-t border-gray-300 pt-8">
                <h2 className="text-sm tracking-wide mb-6">take time off</h2>
