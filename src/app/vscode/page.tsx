    ...
    return (
        ...
        <div className="reflection-container pt-8">
            ...
            <section className="mb-16 md:hidden">
                <h1 className="text-4xl font-normal mb-6">why i switched back to vscode</h1>
            </section>
            ...
            <section className="border-t border-gray-300 pt-8 mb-16">
                <h2 className="text-sm tracking-wide mb-6">those interview fails</h2>
            ...
            <section className="mb-16 border-t border-gray-300 pt-8">
                <h2 className="text-sm tracking-wide mb-6">why i liked cursor</h2>
            ...
            <section className="mb-16 border-t border-gray-300 pt-8">
                <h2 className="text-sm tracking-wide mb-6">switching to vscode</h2>
            ...
            <section className="mb-16 border-t border-gray-300 pt-8">
                <h2 className="text-sm tracking-wide mb-6">how i use ai now</h2>
            ...
            <section className="mb-16 border-t border-gray-300 pt-8">
                <h2 className="text-sm tracking-wide mb-6">conclusion: finding balance</h2>
                ...
                <p className="text-lg md:text-xl mt-4 italic">
